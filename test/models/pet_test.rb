...
# ---------------------------------
  ...
  context "Given context" do
    ...
    setup do 
      create_animals # we need to create aanimals and owners because of the foreign keys existing in pets liniking this table to the owners and animals tables.
      create_owners
      create_pets
    end
