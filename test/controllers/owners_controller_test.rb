...
class OwnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update owner" do
    patch owner_url(@owner), params: { owner: { active: @owner.active, city: @owner.city, email: @owner.email, first_name: @owner.first_name, last_name: @owner.last_name, phone: @owner.phone, state: @owner.state, street: @owner.street, zip: @owner.zip } }
